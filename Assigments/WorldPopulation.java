import java.util.Scanner;
	...
	System.out.printf("World population after one year is: %f%n", secondYear);

	System.out.printf("World population after one year is: %f%n", thirdYear);

	System.out.printf("World population after one year is: %f%n", forthYear);

	System.out.printf("World population after one year is: %f%n", fifthYear);
  }
}